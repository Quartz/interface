...
- **Do not** use the `WPResponsiveImage` for an image whose aspect ratio changes between breakpoints (use an art direction, i.e., `<picture>` solution instead).
